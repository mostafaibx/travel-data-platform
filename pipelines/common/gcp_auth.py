...
def get_credentials(
    ...
    # Priority 2: Environment variable path
        ...
        if os.path.exists(env_path):
            ...
            raise FileNotFoundError(f"Credentials file specified in GOOGLE_APPLICATION_CREDENTIALS not found: {env_path}")
...
def verify_credentials(credentials: service_account.Credentials) -> bool:
    ...
    try:
        ...
        logger.info(f"Credentials verified successfully for project: {credentials.project_id}")
        return True
