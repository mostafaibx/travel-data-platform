...
def upload_raw_data_to_gcs(data: List[Dict[str, Any]], raw_responses: Dict[str, Dict[str, Any]]) -> bool:
    """
    ...
    try:
        ...
        object_name = f"{WEATHER_RAW_PATH}/{year_month}/{day}/weather_data_{file_timestamp}.json"
        ...
        logger.info(f"Successfully uploaded raw weather data to gs://{BUCKET_NAME}/{object_name}")
        return True
