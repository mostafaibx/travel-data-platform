...
def run_pipeline(
    ...
    try:
        ...
        if generate:
            logger.info(f"Generating new travel data using {GENERATION_METHOD} method...")
...
if __name__ == "__main__":
    ...
    if metrics['success']:
        ...
        if generate:
            print(f"Files generated: {metrics['files_generated']} (using {metrics['generation_method']} method)")
        if ingest:
