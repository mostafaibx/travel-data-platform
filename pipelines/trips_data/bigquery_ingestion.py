...
class BigQueryIngestion:
    ...
    def _transform_data(self, df, source_file):
        ...
        # Handle dates
        df_transformed["Start_date"] = pd.to_datetime(
            df_transformed["Start date"]
        ).dt.date
    ...
    def ingest_file(self, file_path):
        ...
        try:
            ...
            logger.info(
                f"Successfully ingested {file_path} to BigQuery and moved to {processed_path}"
            )
            return True
