...
class FakerTravelDataGenerator:
    ...
    def __init__(self):
        ...
        self.multi_faker = Faker(['en_US', 'en_GB', 'ja_JP', 'es_ES', 'de_DE', 'fr_FR', 'zh_CN'])
        ...
        self.destinations = [
            ...
            "Rome, Italy", "Bali, Indonesia", "Barcelona, Spain", "Sydney, Australia",
            "Amsterdam, Netherlands", "Hong Kong", "Dubai, UAE", "Bangkok, Thailand",
            "Cancun, Mexico", "Rio de Janeiro, Brazil", "Cape Town, South Africa",
            "Berlin, Germany", "Seoul, South Korea", "Marrakech, Morocco",
            "Venice, Italy", "Singapore", "Phuket, Thailand", "Athens, Greece",
            "Vienna, Austria", "Kyoto, Japan", "Prague, Czech Republic", 
            "Lisbon, Portugal", "San Francisco, USA", "Toronto, Canada",
            "Bora Bora, French Polynesia", "Stockholm, Sweden"
        ]
        
        # Accommodation types
        self.accommodation_types = [
            "Hotel", "Hostel", "Airbnb", "Resort", "Villa", "Guesthouse",
            "Vacation rental", "Apartment", "Boutique hotel", "Riad"
        ]
        
        # Transportation types
        self.transportation_types = [
            "Flight", "Train", "Bus", "Car rental", "Ferry", "Subway",
            "Plane", "Taxi", "Cruise", "Private car"
        ]
    ...
    def generate_trips(self, num_trips=config.BATCH_SIZE):
        ...
        for _ in range(num_trips):
            ...
            trip = {
                ...
                'Traveler nationality': self.multi_faker.random_element(elements=('American', 'British', 'Japanese', 'Spanish', 'German', 'French', 'Chinese', 'Australian', 'Canadian', 'Italian', 'Brazilian', 'Mexican', 'Korean')),
