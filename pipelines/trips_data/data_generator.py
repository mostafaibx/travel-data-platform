...
class TravelDataGenerator:
    ...
    def __init__(self):
        ...
        self.accommodation_cost_distribution = self._get_cost_distribution('Accommodation cost')
        self.transportation_cost_distribution = self._get_cost_distribution('Transportation cost')
    ...
    def generate_trips(self, num_trips=config.BATCH_SIZE):
        ...
        for _ in range(num_trips):
            ...
            trip = {
                ...
                'Accommodation cost': self._generate_cost(self.accommodation_cost_distribution),
                'Transportation type': random.choice(self.transportation_types),
                'Transportation cost': self._generate_cost(self.transportation_cost_distribution)
            }
