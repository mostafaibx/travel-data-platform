...
class TestBigQueryLoader:
    ...
    def test_upload_dataframe(self, mock_job_config, mock_client_class, sample_processed_df):
    ...
    @patch('pipelines.scrapping_dest_details.bigquery_loader.bigquery.Client')
    @patch('pipelines.scrapping_dest_details.bigquery_loader.bigquery.LoadJobConfig')
    def test_upload_dataframe_failure(self, mock_job_config, mock_client_class, sample_processed_df):
    ...
    def test_upload_new_table_success(
        self, mock_upload, mock_check_table, mock_create_dataset, mock_check_dataset, 
        sample_processed_df
    ):
    ...
    @patch('pipelines.scrapping_dest_details.bigquery_loader.bigquery.Client')
    def test_upload_with_merge_temp_table_failure(self, mock_client_class, sample_processed_df):
    ...
    @patch('pipelines.scrapping_dest_details.bigquery_loader.bigquery.Client')
    def test_upload_with_merge_query_failure(self, mock_client_class, sample_processed_df):
