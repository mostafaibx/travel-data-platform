...
class TestWikipediaScraper:
    ...
    def test_fetch_page(self, mock_session_class, mock_requests_session):
        ...
        mock_session_instance.get.assert_called_once_with("https://en.wikipedia.org/wiki/Paris")
    ...
    def test_extract_destination_info(self, mock_soup):
        ...
        assert any(attraction['name'] == 'Eiffel Tower' for attraction in info['attractions'])
        assert any(attraction['name'] == 'Louvre Museum' for attraction in info['attractions'])
...
def test_get_destination_info(mock_scraper_class, mock_soup, mock_raw_data):
    ...
    mock_scraper_instance.extract_destination_info.assert_called_once_with(mock_soup, "Paris")
