...
def main():
    ...
    """
    parser = argparse.ArgumentParser(description="Run tests for scrapping_dest_details pipeline")
    parser.add_argument("--with-coverage", action="store_true", help="Run with coverage reporting")
    parser.add_argument("--junit-xml", help="Output JUnit XML report to the given file")
    parser.add_argument("--html-report", help="Output HTML coverage report to the given directory")
    ...
    # Add all test files
    pytest_args.extend(["test_fetcher.py", "test_pipeline.py", "test_gcs_storage.py", 
                       "test_bigquery_loader.py", "test_schema_validation.py"])
