...
def test_bigquery_schema_validation(sample_processed_df):
    ...
    # Numeric columns
    ge_df.expect_column_values_to_be_in_type_list('latitude', ['float', 'int', 'float64', 'int64'])
    ge_df.expect_column_values_to_be_in_type_list('longitude', ['float', 'int', 'float64', 'int64'])
    ge_df.expect_column_values_to_be_in_type_list('population_count', ['float', 'int', 'float64', 'int64'])
    ge_df.expect_column_values_to_be_in_type_list('attractions_count', ['float', 'int', 'float64', 'int64'])
